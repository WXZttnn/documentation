...
Odoo eCommerce provides several options to organize the order process. To enable or
add them on the product page, go to :menuselection:`Website --> Configuration --> Settings`. Under
...
By default, the :guilabel:`Add to cart` button is displayed on the product's page. It provides
...
block. This is an *additional* button to the regular :guilabel:`Add to Cart` button.
